						...
						<form action="<?php echo site_url('puskesmas/pasienrujukan_index/edit_save/'.$pasienrujukan->id_rujukan) ?>" method="post">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('no_rujukan') ? 'is-invalid':'' ?>"
								 type="text" name="no_rujukan" placeholder="Nomor Rujukan Pasien" value="<?= $pasienrujukan->no_rujukan; ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('puskesmas') ? 'is-invalid':'' ?>"
								 type="text" name="puskesmas" placeholder="Nama Puskesmas" value="<?= $pasienrujukan->puskesmas; ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kab_kota') ? 'is-invalid':'' ?>"
								 type="text" name="kab_kota" placeholder="Kabupaten/Kota" value="<?= $pasienrujukan->kab_kota; ?>">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('poli') ? 'is-invalid':'' ?>"
								 type="text" name="poli" placeholder="Poli Yang Dituju" value="<?= $pasienrujukan->poli; ?>">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>" id="alamat" name="alamat" placeholder="Alamat" rows="3"><?= $pasienrujukan->alamat; ?></textarea>
								<div class="invalid-feedback">
