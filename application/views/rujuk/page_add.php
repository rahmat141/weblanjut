...
<?php $this->load->view('admin/_partials/breadcrumb');?>
	...
	<form action="<?php echo site_url('pasienrujukan/insert') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-7">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input name="nopasien" type="text" <?php echo form_error('nopasien') ? 'is-invalid':'' ?> class="form-control" id="nopasien" placeholder="Masukan Nomor Pasien">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-7">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <textarea name="diagnosa" class="form-control" id="diagnosa" rows="3" placeholder="Masukan Diagnosa"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    <label for="rumahsakit" class="col-sm-3 col-form-label">Puskesmas</label>
                                    <div class="col">
